...
exports.gitChangedFileSelector = void 0;
...
function buildDiff(cwd, items) {
    ...
    for (const item of items) {
        ...
        try {
            const diff = (0, child_process_1.execFileSync)("git", ["diff", "HEAD", "--", item.path], {
                cwd,
                encoding: "utf8",
                maxBuffer: 10 * 1024 * 1024
            }).trim();
...
function buildPromptOverride(branch, items, diff) {
...
function postInfo(context, text) {
    context.panel.webview.postMessage({
        type: "selectorInfo",
        text
    });
}
async function refreshFromGit(context) {
...
exports.gitChangedFileSelector = {
    mode: "git_changed",
    requiresFiles: true,
    render() {
        return `
...
//# sourceMappingURL=gitChanged.js.map