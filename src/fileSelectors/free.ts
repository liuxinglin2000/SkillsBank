...
function appendUniqueFiles(target: string[], incoming: string[]): void {
...
function collectFilesFromPath(entryPath: string): string[] {
...
export const freeFileSelector: FileSelectorHandler = {
  mode: "free",
  requiresFiles: true,
  render(): string {
    return `
